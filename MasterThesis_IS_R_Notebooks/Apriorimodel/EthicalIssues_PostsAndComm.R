...
# Read the dataset
data_posts_comments <- read.csv("Apriorimodel/data/FinalAnnotationSheet.csv")
...
write.csv(data_posts_comments, "Apriorimodel/data/FinalAnnotationSheet_OnlyOneIssueRemoved_PostComments.csv", row.names = FALSE)

#Read the new filtered CSV File
data_posts_comments <- read.csv("Apriorimodel/data/FinalAnnotationSheet_OnlyOneIssueRemoved_PostComments.csv")
