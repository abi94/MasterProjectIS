...
# Read the dataset
data_posts <- read.csv("Apriori/FinalAnnotationSheet.csv")
...
write.csv(data_posts, "Apriori/FinalAnnotationSheet_OnlyOneIssueRemoved_posts.csv", row.names = FALSE)

#Read the new filtered CSV File
data_posts <- read.csv("Apriori/FinalAnnotationSheet_OnlyOneIssueRemoved_posts.csv")
