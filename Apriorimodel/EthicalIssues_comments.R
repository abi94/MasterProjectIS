...
# Read the dataset
data_comments <- read.csv("Apriori/FinalAnnotationSheet.csv")
...
write.csv(data_comments, "Apriori/FinalAnnotationSheet_OnlyOneIssueRemoved_Comments.csv", row.names = FALSE)

#Read the new filtered CSV File
data_comments <- read.csv("Apriori/FinalAnnotationSheet_OnlyOneIssueRemoved_Comments.csv")
